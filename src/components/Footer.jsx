              ...
              <div className="col">
                ...
                <Link
                  ...
                  <Link
                    ...
                    className="mb-3 text-decoration-none text-dark"
                  >
                    <PhoneIphone />Jameel Ghori +91 9921145831
                  </Link>
                  <Link
                    to="https://wa.me/message/M53JJO5UE33UF1"
                    target="_blank"
                    className="mb-3 text-decoration-none text-dark"
                  >
                    <PhoneIphone />Hannan Ghori +91 +91 75067 50794
                  </Link>
                  <p
...
B-206, Navkar Chambers, Near Marol Naka Metro Station,Andheri-Kurla Road,Andheri East, mumbai-400059
