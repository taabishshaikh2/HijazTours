      ...
      <div className="mt-4 row">
        <div className="col-md-6 ">
          <div className="info email mb-3">
            <p>
            Our objective is to help the community to perform Hajj & thus fulfill an obligation of lifetime and enable pilgrims travel to Islam's Holiest Shrines in comfort, dignity and in proper frame of mind. We are proud to inform you that Hijaz Tours & Travels are registered with the Ministry of Minority affairs, Govt. of India & Ministry of Hajj, Saudi Arabia and member of various Associations.
Almost 24 years on and we are still building global bonds of brother and sisterhood by providing excellence every step of the way for Hajj and Umrah.

            </p>

            <p>
Our core ethos of khidma (service) underpins everything we do. And we guarantee that all of our customers’ needs will be comfortably met, their expectations exceeded and their goals before the start of the journey, accomplished. We push ourselves to go above and beyond what is expected of us, paying attention to the little details that are often missed.
